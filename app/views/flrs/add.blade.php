...
<div class="row">
 <div class="col-md-12">
         <h3 class="text-center">Skapa ny instans</h3>
     </div>
      <div class="col-md-6">
        <ol class="breadcrumb">
         <li><a href="/admin">Admin Dashboard</a></li>
         <li><a href="/admin/flrs/instance">Instanser </a></li>
         <li class="active">Skapa instans</li>
        </ol>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="form-group">
                {{Form::open(['route' => 'raids.store', 'files' => true])}}
                <div class="form-group">
                {{Form::label('title', 'Ange namn på Raid')}}
                {{Form::text('title', null, ['class' => 'form-control'])}}
                </div>
                <div class="form-group">
                {{Form::label('backgroundImg', 'Ladda upp en bakgrundsbild till raiden. Bäst upplösning är 1920 * 1080.')}}
